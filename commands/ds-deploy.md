...
package up as a local callable endpoint with monitoring, drift detection, and a
rollback pointer — confirming before any outward push. Pass along any details the
